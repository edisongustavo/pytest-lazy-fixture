...
#     for item in items:
#         assert any(
#             is_subset(result, item.callspec.params) for result in expected_results
#         )
#
#
...
#     [
#         ({"some": lf("one"), "one": lf("three")}, ["one>some"],),
#         (
#             {
#                 "grand1": lf("parent1_1"),
#                 "parent1_1": lf("child1"),
...
#             },
#             [
#                 "child1>parent1_1>grand1>parent1_2>grand2",
#                 "child1>parent1_2>grand2>parent1_1>grand1",
#             ],
#         ),
#         ({"param1": "val1", "param2": "val2"}, ["param1>param2", "param2>param1"]),
#         ({}, [""]),
#         ({"param1": "val1"}, ["param1"]),
...
#
# @pytest.mark.parametrize(
#     "params,fixturenames,expect_keys",
#     [
...
#     assert (
#         "using module fixture using fixture1 using module fixture using fixture2"
#         in stdout
#     )
#
#
...
#     assert (
#         # pytest==3.2.5
#         "using autouse_fixture using module fixture using fixture1 using autouse_fixture using fixture2"
#         in stdout
#         or "using module fixture using autouse_fixture using fixture1 using autouse_fixture using fixture2"
#         in stdout
#     )
#
#
# @pytest.mark.parametrize(
#     "autouse_scope",
#     ["session", "module", pytest.param("function", marks=pytest.mark.xfail)],
# )
# def test_session_autouse_and_usefixture_module_scope_runs_before_function_fixtures(
#     testdir, autouse_scope
# ):
#     testdir.makepyfile(
#         """
#         import pytest
...
#                 print(' '.join(invocation_order))
#     """.format(
#             autouse_scope=autouse_scope
#         )
#     )
#     result = testdir.runpytest("-s")
#     assert (
#         "using autouse_fixture using module fixture using fixture1 using fixture2"
...
#         or "using module fixture using fixture1 using fixture2" in stdout
#     )
#
#
...
def test_fixture_in_parametrize_returning_callable(testdir):
    testdir.makepyfile(
        """
        import pytest
        @pytest.fixture
        def one_from_pure_function(request):
            def func(number=0):
                return number + 1
            return func

        @pytest.fixture
        def one_from_class(request):
            class func:
        ...
        @pytest.fixture
        def one_from_class_accumulating(request):
            class func:
                def __init__(self):
                    self.value = 0
                def __call__(self):
        ...
        @pytest.mark.parametrize('arg, expected', [
            (pytest.lazy_fixture('one_from_pure_function'), 1),
            (pytest.lazy_fixture('one_from_pure_function')(), 1),
            (pytest.lazy_fixture('one_from_pure_function')(5), 6),
            #(pytest.lazy_fixture('one_from_class'), 1),
            #(pytest.lazy_fixture('one_from_class')(), 1),
            #(pytest.lazy_fixture('one_from_class')(5), 6),
            #(pytest.lazy_fixture('one_from_class_accumulating'), 1),
            #(pytest.lazy_fixture('one_from_class_accumulating')(), 1),
            #(pytest.lazy_fixture('one_from_class_accumulating')(5), 6),
        ])
        def test_callable_fixture(arg, expected):
            if callable(arg):
                assert arg() == expected
            else:
                assert arg == expected
